...
const projects = [
  ...
  },
  {
    ...
    points: [
      'Mapbox GL 라이브러리를 통해 Head office 위치를 시각화한 인터랙티브 지도 구현.',
      'React CountUp 라이브러리를 통해 통계 데이터를 역동적인 애니메이션으로 표시.',
      'React Fast Marquee: 사용자 몰입감을 높이는 텍스트 슬라이더 효과 적용.',
      'Storybook: UI 컴포넌트를 체계적으로 개발 및 관리.',
      'News 카테고리 필터 기능: Sanity CMS에서 제공된 카테고리 데이터를 기반으로 동적으로 필터 기능 구현.',
      'Next.js: export const dynamic = "force-static"를 사용해 특정 페이지를 정적으로 생성, 더 나은 성능과 캐싱 최적화 구현.',
      'React Share: 소셜 미디어 공유 기능을 통해 사용자 참여도 향상.',
    ],
    image: tab,
  ...
  },
  {
    ...
    points: [
      'SSG(Static Site Generation)를 활용하여 웹사이트 속도를 최적화했습니다. 페이지를 빌드 시 미리 생성하여 서버의 부담을 줄이고, 사용자에게 빠르고 안정적인 로딩 속도를 제공할 수 있었습니다.',
